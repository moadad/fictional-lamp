(function(){
  ...
  const Api={
    ...
    clientModels:(client,ready=false,force=false)=>{if(force)clear('getClientModels');return request('getClientModels',attachAuth({client,ready:ready?'true':'false',...(force?{force:'true'}:{})}),{ttl:force?0:18000,dedupe:!force})},
